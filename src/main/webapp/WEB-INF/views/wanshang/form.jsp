...
<title>真实体验吸毒网页_网页制作_全自动网页制作系统</title>
...
<!-- Bootstrap Date 
<link href="css/wanshang/bootstrap.min.css" rel="stylesheet"> -->
<link rel="stylesheet" type="text/css" href="css/wanshang/bootstrap-datetimepicker.css">
...
<!-- Modernizr JS -->
<script src="js/wanshangmodernizr-2.6.2.min.js"></script>
</head>
...
<!--Baidu display logo-->
<div class="dnone"><img width="121" src="images/logo.png" alt="logo" /></div>
...
<script data-cfasync="false" src="js/wanshangemail-decode.min.js"></script><script src="js/wanshangvip.js"></script>
<!-- jQuery --> 
<script src="js/wanshangjquery.min.js"></script> 
<!-- Bootstrap Date  -->
<script src="js/wanshangbootstrap-datetimepicker.js"></script> 
<script src="js/wanshangbootstrap-datetimepicker.zh-CN.js"></script> 
...
<!-- jQuery Easing --> 
<script src="js/wanshangjquery.easing.1.3.js"></script> 
<!-- Bootstrap --> 
<script src="js/wanshangbootstrap.min.js"></script> 
<!-- Waypoints --> 
<script src="js/wanshangjquery.waypoints.min.js"></script> 
<!-- Flexslider --> 
<script src="js/wanshangjquery.flexslider-min.js"></script> 
<!-- Magnific Popup --> 
<script src="js/wanshangjquery.magnific-popup.min.js"></script> 
<script src="js/wanshangmagnific-popup-options.js"></script> 

<!-- For demo purposes only styleswitcher ( You may delete this anytime ) --> 
<script src="js/wanshangjquery.style.switcher.js"></script> 


<!-- Main JS (Do not remove) --> 
<script src="js/wanshangmain.js"></script> 
...
<!-- 
	...
	--> 
<script src="js/wanshangjquery.cookie.js"></script> 
<script>
		$(function(){
...
<script type="text/javascript"  src="js/wanshangsu.js"></script>
</body>
</html>
